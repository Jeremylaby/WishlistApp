...
public class UserEventProducerService  {
    ...
    private final static String USER_REGISTERED_TOPIC = "user_registered";
    private final static String USER_DELETE_TOPIC = "user_delete";

    public UserEventProducerService(KafkaTemplate<String, UserRegisteredEvent> userRegisteredTemplate,
